...
int main() {
    Calculater::BigInt a("753275733897352885583252657455685685"), b("723587383839");
    auto aa = 753275733897352885583252657455685685_int128;
    auto bb = 723587383839_int128;
    ...
    std::cout << "Моя реализация: " << std::chrono::duration<double>(end1-start1).count() << "\n";

    start1 = std::chrono::system_clock::now();
    std::cout << aa+bb << std::endl;
    end1 = std::chrono::system_clock::now();

    std::cout << "Библиотека <int_width>: " << std::chrono::duration<double>(end1-start1).count() << "\n";
